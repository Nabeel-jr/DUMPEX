    ...
    if request.user.is_authenticated:
        ...
        if user_type == 1:  # Customer
            ...
            more = [
                ...
                {'name': 'MANAGE EMP', 'url': 'manager:manage_employees', 'icon': 'fas fa-user-cog'},

            ]
            
        elif user_type == 4:  # Admin
            navigation = [
                {'name': 'DASHBOARD', 'url': 'admin_module:admin_dashboard', 'icon': 'fas fa-tachometer-alt'},
                {'name': 'WALLETS', 'url': 'wallet:view_balance', 'icon': 'fa fa-wallet'},
