"""
Django settings for dumpex project.
...
SECRET_KEY = 'django-insecure-=n*fdf)ms^efx1&0w+-)-wq4+*f%h0qc%fti+4+e!4u9q7&(^h'
...
WSGI_APPLICATION = 'dumpex.wsgi.application'
